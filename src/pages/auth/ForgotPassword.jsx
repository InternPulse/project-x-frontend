    ...
    <main className="w-full h-auto">
      <div className="flex">
        <div className="h-full w-1/2 hidden md:block lg:block">
          <img
            className="h-2/5 object-fit:cover object-position: center"
            style={{
          ...
          <div className="items-center h-full w-full">
            ...
            <div className="w-11/12 mx-auto">
              <div>
                ...
                <p>
                  Enter the Email address used to create your Interpulse account
              ...
              <div>
                ...
                <button
                  className="w-full h-full bg-primary-500 rounded-lg"
                  onClick={toggleModal}
                >
                  Next
                </button>
